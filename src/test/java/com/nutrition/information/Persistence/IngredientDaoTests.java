...
class IngredientDaoTests {
	...
	void addTest() {
		...
		int rowsAffectedKidnyBeans = ingredientDao.insert("Kidny beans", "Beans", "cup", 1.5f, 1.0f, 16.0f, 8.0f,
				110.0f, "Not Specified");
		int rowsAffectedWhiteBeans = ingredientDao.insert("White beans", "Beans", "cup", 1.5f, 0.0f, 17.0f, 6.0f, 90.0f,
				"Not Specified");
	...
	@Test
	void getTest() {
		Ingredient expected = new Ingredient("Kidny beans", ingredientType, unit, 3.0f, 2.0f, 32.0f, 16.0f, 220.0f,
				warning);
	...
	@Test
	void updateTest() {
		int rowAffected = ingredientDao.update("Kidny beans", "Beans", "cup", 3.0f, 2.0f, 32.0f, 16.0f, 220.0f,
				"Not Specified");
