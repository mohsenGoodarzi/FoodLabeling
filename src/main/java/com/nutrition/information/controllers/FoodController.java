...
public class FoodController {
	...
	public ModelAndView create(@ModelAttribute Food food, RedirectAttributes redirectAttributes) {
		...
		try {
			...
			return httpHelper.redirect(
					new ErrorView(501, "Could not add new food", "Try again later or contact support team."),
	...
	public ModelAndView edit(@PathVariable String foodId, RedirectAttributes redirectAttributes) {
		...
		if (food == null) {
			return httpHelper.redirect(new ErrorView(501, "The food cannot be edited", "try again later"), modelAndView,
					redirectAttributes);
		}
	...
	public ModelAndView delete(@PathVariable("foodId") String foodId, RedirectAttributes redirectAttributes) {
		...
		Food food = foodService.getFood(foodId);
		if (food == null) {
			return httpHelper.redirect(new ErrorView(403, "Not Found", "The food was not found."), modelAndView,
					redirectAttributes);
		}
		modelAndView.addObject("food", food);
	...
	@GetMapping("Delete")
	public ModelAndView deleteConfirmed(@ModelAttribute("foodId") String foodId,
